...
export const dashboardApi = {
  ...
  getPendingPoints: (startDate?: string, endDate?: string) =>
    api.get('/dashboard/pending-points', { params: { start_date: startDate, end_date: endDate } }),
  ...
  getActivityPeakHours: (startDate?: string, endDate?: string) =>
    api.get('/dashboard/activity-peak-hours', { params: { start_date: startDate, end_date: endDate } }),
